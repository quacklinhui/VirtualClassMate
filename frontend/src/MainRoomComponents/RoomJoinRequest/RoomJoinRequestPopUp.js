        ...
        <div className = "PopUp">
            <div className = "popup-inner">
                ...
                <div className = "requestsToAccept">
                    {loading ? ((props.roomAdmin != props.userId) ? <RoomJoinRequest isAdmin = 'false' userId = {props.userId}/> : (!requestNameList.length ? <RoomJoinRequest hasRequest = 'false' isAdmin = 'true'/> : requestNameList.map((request) => <RoomJoinRequest key = {request._id} hasRequest = 'true' userId = {props.userId} newMemberId = {request._id} newMemberName = {request.name} roomId = {props.roomId} isAdmin = 'true'/>))) :
